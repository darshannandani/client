...
const PodcastCard = () => {
    return (
        <Card>
            <div>
                <Top>
                    <Favorite style={{ color: "#E30022", width: '20px', height: '20px' }} >
                        <FavouriteIcon style={{ margin: "-2" }} />
                    </Favorite>
                ...
                <CardInformation>
                    <MainInfo>
                        ...
                        <Description>
                            ...
                            adipisicing elit. Natus nesciunt temporibus
                            architecto ad. Sint, consectetur assumenda.
                            Nisi nulla dolore quo?
                        </Description>
                        <CreatersInfo>
                            <Creator>
